...
def process_h5_file_wrapper(path):
    ...
    try:
    	s3.meta.client.upload_file(name, 'whateversongs', name)
    except Exception:
    	print("fk this class")
...
Note: If you have 4 workers, yNov 23, 2020ou are expected to run the scripts 4 times with
